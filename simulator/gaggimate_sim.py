...
使い方:
    ...
    python gaggimate_sim.py [--host 0.0.0.0] [--ws-port 8766] [--webhook-url http://localhost:8001/webhook]
...
def main() -> None:
    ...
    parser.add_argument("--webhook-url", default=None, help="Webhook URL for shot completion (e.g. http://localhost:8001/webhook)")
